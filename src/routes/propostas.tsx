...
import { z } from "zod";
import { Check, ChevronDown, Copy, Download, Edit, Eye, FileDown, MoreHorizontal, Plus, RotateCcw, Search, Trash2, X } from "lucide-react";
...
function ProposalsPage() {
  ...
  const setSearch = (patch: Partial<typeof search>) => navigate({ search: (prev) => ({ ...prev, ...patch }) });
