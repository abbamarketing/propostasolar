...
import { ArrowLeft, Copy, Download, Edit, FileText, MoreHorizontal, RotateCcw, Trash2 } from "lucide-react";
...
function ProposalDetailPage() {
  ...
  if (!proposal.data) return <AppLayout><EmptyState title="Proposta não encontrada" description="Ela pode ter sido removida ou você não tem acesso." /></AppLayout>;
